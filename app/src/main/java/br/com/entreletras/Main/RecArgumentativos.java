...
public class RecArgumentativos extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rec_argumentativos);
        ...
        setTitle("Recursos Argumentativos");
        JsonConsumerTodos consumerTodos = new JsonConsumerTodos(this);

        try {
            conteudos = consumerTodos.execute("recarg.txt").get();
