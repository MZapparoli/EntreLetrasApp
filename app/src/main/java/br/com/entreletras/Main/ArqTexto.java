...
public class ArqTexto extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_arq_texto);
        ...
        setTitle("Arquitetura do Texto");
        JsonConsumerTodos consumerTodos = new JsonConsumerTodos(this);

        try {
            conteudos = consumerTodos.execute("arqtext.txt").get();
